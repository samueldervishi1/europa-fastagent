...
class MCPAggregator(ContextDependent):
    ...
    async def load_servers(self) -> None:
        ...
        for server_name in self.server_names:
            if self.connection_persistence:
                ...
                await self._persistent_connection_manager.get_server(server_name, client_session_factory=session_factory)
    ...
    async def _get_resource_from_server(self, server_name: str, resource_uri: str) -> ReadResourceResult:
        """
